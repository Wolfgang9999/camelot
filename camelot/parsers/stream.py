...
class Stream(BaseParser):
    ...
    def _text_bbox(t_bbox):
        ...
        """
        xmin = min([t.left for direction in t_bbox for t in t_bbox[direction]])
        ymin = min([t.bottom for direction in t_bbox for t in t_bbox[direction]])
        xmax = max([t.right for direction in t_bbox for t in t_bbox[direction]])
        ymax = max([t.top for direction in t_bbox for t in t_bbox[direction]])
